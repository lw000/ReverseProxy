...
type ReqRegService struct {
	...
	SrvVersion uint32 `protobuf:"varint,3,opt,name=srvVersion" json:"srvVersion,omitempty"`
...
func (*ReqRegService) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*AckRegService) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*ReqUpdateConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*AckUpdateConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
